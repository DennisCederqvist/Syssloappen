...
namespace Syssloappen.Api.Migrations
{
    ...
    [Migration("20260916093359_EnableRowLevelSecurityOnNewerTables")]
    partial class EnableRowLevelSecurityOnNewerTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Syssloappen.Api.Authentication.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("ChildUserName")
                        .HasMaxLength(50)
                    ...
                    b.Property<string>("NormalizedChildUserName")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");
                    ...
                    b.HasIndex("HouseholdId", "NormalizedChildUserName")
                        .IsUnique();

                    b.ToTable("AspNetUsers", (string)null);
                });

            modelBuilder.Entity("Syssloappen.Api.Models.ChildDeviceSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("HouseholdId", "ChildProfileId");

                    b.ToTable("ChildDeviceSessions");
                });

            modelBuilder.Entity("Syssloappen.Api.Models.ChildPairingCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Syssloappen.Api.Models.Chore", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Syssloappen.Api.Models.ChoreAssignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Syssloappen.Api.Models.ChoreCompletion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Syssloappen.Api.Models.Household", b =>
                {
                    ...
                    b.Property<string>("FamilyCodeHash")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");

                    b.Property<string>("FamilyCodeLastFour")
                        .HasMaxLength(4)
                        .HasColumnType("character varying(4)");

                    b.Property<DateTime?>("FamilyCodeUpdatedAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Syssloappen.Api.Models.HouseholdInvitation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("HouseholdId", "UsedAt");

                    b.ToTable("HouseholdInvitations");
                });

            modelBuilder.Entity("Syssloappen.Api.Models.PushSubscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Syssloappen.Api.Models.Reward", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Syssloappen.Api.Models.ChildDeviceSession", b =>
                {
                    b.HasOne("Syssloappen.Api.Models.ChildProfile", "ChildProfile")
                        .WithMany()
                    ...
                    b.HasOne("Syssloappen.Api.Authentication.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Syssloappen.Api.Models.ChildProfile", b =>
                {
                    ...
                    b.HasOne("Syssloappen.Api.Authentication.ApplicationUser", "User")
                        .WithOne()
                        .HasForeignKey("Syssloappen.Api.Models.ChildProfile", "UserId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("Syssloappen.Api.Models.ChoreAssignment", b =>
                {
                    b.HasOne("Syssloappen.Api.Authentication.ApplicationUser", "AssignedByUser")
                        .WithMany()
                    ...
                    b.HasOne("Syssloappen.Api.Authentication.ApplicationUser", "ReviewedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Syssloappen.Api.Models.ChoreCompletion", b =>
                {
                    b.HasOne("Syssloappen.Api.Authentication.ApplicationUser", "ApprovedByUser")
                        .WithMany()
                        .HasForeignKey("ApprovedByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Syssloappen.Api.Models.ChoreAssignment", "Assignment")
                        .WithMany()
            ...
            modelBuilder.Entity("Syssloappen.Api.Models.Household", b =>
                {
                    b.HasOne("Syssloappen.Api.Authentication.ApplicationUser", "OwnerUser")
                        .WithMany()
