...
{
    /// <inheritdoc />
    public partial class AddRewardsCatalog : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Rewards_PointsCost_Positive", "\"PointsCost\" > 0");
                    table.ForeignKey(
                        name: "FK_Rewards_AspNetUsers_CreatedByUserId",
