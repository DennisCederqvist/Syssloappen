...
Verifierat: 147/147 backendtester (Release), `ng build` rent, 53/56 frontendtester (samma 3 sedan tidigare kända och ofärgade testfel), hela `npm run e2e`-svepet grönt, samt två fullständiga körningar mot en riktig instans — en för själva vuxenhanteringen (ägarskydd, andra vuxens inbjudan, tvåstegsbekräftelsen, listuppdatering utan omladdning, omedelbar sessionsogiltigförklaring, e-postfrigöring) och en för den samlade sidan plus profil/lösenord (18 kontrollpunkter, inklusive att ett bytt lösenord verkligen fungerar för inloggning efter utloggning).
