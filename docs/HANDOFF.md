...
3. **Frontend, "Hantera vuxna" och komplett "Bjud in vuxen".** Ny rad i Inställningar → `/vuxen/installningar/vuxna` listar Householdets vuxna med badge för huvudägare/inbjuden; icke-ägarrader (inklusive den egna) har en inbyggd tvåstegsbekräftelse innan bortkoppling, med samma mönster som redan används för enhetssessioner och barn-avaktivering. "Bjud in vuxen" visar nu samma lista skrivskyddad under inbjudningskoden, med en länk till "Hantera vuxna" för själva åtgärden. Att koppla bort sig själv rensar lokalt sessionstillstånd och leder direkt till `/login` utan en extra utloggningsrundtur mot en session backend redan ogiltigförklarat.

Verifierat: 139/139 backendtester (Release), `ng build` rent, 53/56 frontendtester (samma 3 sedan tidigare kända och ofärgade testfel), hela `npm run e2e`-svepet grönt, samt en fullständig körning mot en riktig instans som täckte ägarskydd, en andra vuxens inbjudan, tvåstegsbekräftelsen, listuppdatering utan omladdning, omedelbar sessionsogiltigförklaring och e-postfrigöring för en ny registrering.
